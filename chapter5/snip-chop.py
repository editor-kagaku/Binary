...
import refinery.units.meta.chop
import refinery.units.strings.snip
...
snip = refinery.units.strings.snip.snip([slice(4, 12), slice(None, -5, -1)])

# データを切り出すジェネレータを生成する
gen = snip.process(data)
...
chop = refinery.units.meta.chop.chop(4)

gen = chop.process(data)
